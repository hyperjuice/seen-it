Post.create!([
  ...
  {name: "What does * { box-sizing: border-box; } do? What are its advantages?", content: "What does * { box-sizing: border-box; } do? What are its advantages?", user_id: 1, difficulty: "", link: "https://github.com/h5bp/Front-end-Developer-Interview-Questions", tag_id: nil},
  ...
  {name: "Explain how this works in JavaScript", content: "Explain how this works in JavaScript", user_id: 1, difficulty: "", link: "https://github.com/h5bp/Front-end-Developer-Interview-Questions", tag_id: nil},
  ...
  {name: "Difference between: function Person(){}, var person = Person(), and var person = new Person()?", content: "Difference between: function Person(){}, var person = Person(), and var person = new Person()?", user_id: 1, difficulty: "", link: "https://github.com/h5bp/Front-end-Developer-Interview-Questions", tag_id: nil},
  ...
  {name: "What is the difference between == and ===?", content: "What is the difference between == and ===?", user_id: 1, difficulty: "", link: "https://github.com/h5bp/Front-end-Developer-Interview-Questions", tag_id: nil},
  ...
  {name: "Make this work:", content: "Make this work:", user_id: 1, difficulty: "", link: "https://github.com/h5bp/Front-end-Developer-Interview-Questions", tag_id: nil},
  ...
  {name: "What are the differences between null and undefined?", content: "What are the differences between null and undefined?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the differences between == and ===?", content: "What are the differences between == and ===?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would you compare two objects in JavaScript?", content: "How would you compare two objects in JavaScript?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "11+ true false related questions that will trick you.", content: "11+ true false related questions that will trick you.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "As [] is true, [] == true should also be true. right?", content: "As [] is true, [] == true should also be true. right?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you write a method on instance of a date which will give you next day?", content: "How could you write a method on instance of a date which will give you next day?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "If you want to use an arbitrary object as value of this, how will you do that?", content: "If you want to use an arbitrary object as value of this, how will you do that?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Write a simple function to tell whether 2 is passed as parameter or not?", content: "Write a simple function to tell whether 2 is passed as parameter or not?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you use Math.max to find the max value in an array?", content: "How could you use Math.max to find the max value in an array?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What the heck is this in JavaScript?", content: "What the heck is this in JavaScript?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "21 quick questions that will trick you.", content: "21 quick questions that will trick you.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you set a prefix before everything you log? for example, if you log('my message') it will log: \"(app) my message\"", content: "How could you set a prefix before everything you log? for example, if you log('my message') it will log: \"(app) my message\"", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What will you see in the console for the following example?", content: "What will you see in the console for the following example?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Look at the code below, you have a for loop if you have setTimeout inside it. If log the loop counter inside setTimeout, what will be logged?", content: "Look at the code below, you have a for loop if you have setTimeout inside it. If log the loop counter inside setTimeout, what will be logged?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Look at the code below, I have a property in a object and I am creating a new object where I am setting it to a new value. If I delete that property what will i get if I try to access that property?", content: "Look at the code below, I have a property in a object and I am creating a new object where I am setting it to a new value. If I delete that property what will i get if I try to access that property?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Does JavaScript pass parameter by value or by reference?", content: "Does JavaScript pass parameter by value or by reference?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you implement cache to save calculation time for a recursive fibonacci function?", content: "How could you implement cache to save calculation time for a recursive fibonacci function?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you cache execution of any function?", content: "How could you cache execution of any function?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "If you need to implement the following chaining with call back, how will you implement it?", content: "If you need to implement the following chaining with call back, how will you implement it?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you implement moveLeft animation?", content: "How could you implement moveLeft animation?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would you implement currying for any functions? ", content: "How would you implement currying for any functions? ", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What does float do?", content: "What does float do?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  ...
  {name: "Which one would you prefer among px, em % or pt and why?", content: "Which one would you prefer among px, em % or pt and why?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How absolute, relative, fixed and static position differ?", content: "How absolute, relative, fixed and static position differ?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the differences between visibility hidden and display none?", content: "What are the differences between visibility hidden and display none?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the differences between inline, block and inline-block?", content: "What are the differences between inline, block and inline-block?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the properties related to box model?", content: "What are the properties related to box model?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Does overflow: hidden create a new block formatting context?", content: "Does overflow: hidden create a new block formatting context?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  ...
  {name: "What are the some pseudo classed u have used?", content: "What are the some pseudo classed u have used?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How do you align a p center-center inside a div?", content: "How do you align a p center-center inside a div?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How do you optimize css selectors?", content: "How do you optimize css selectors?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How can you load css resources conditionally?", content: "How can you load css resources conditionally?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Why would you use sprites?", content: "Why would you use sprites?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is specificity? How do u calculate specificity?", content: "What is specificity? How do u calculate specificity?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is shadow DOM?", content: "What is shadow DOM?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What do you know about transition?", content: "What do you know about transition?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the different css filter you can use?", content: "What are the different css filter you can use?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the reasons to use preprocessor?", content: "What are the reasons to use preprocessor?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "\nShow you couple of style example and you have to tell what does it do.", content: "\nShow you couple of style example and you have to tell what does it do.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How descendant css selectors are matched? get answer\n", content: "How descendant css selectors are matched? get answer\n", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would u implement modularity in css?", content: "How would u implement modularity in css?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "If something doesn't work in a specific browser (IE8), you would u approach this problem?", content: "If something doesn't work in a specific browser (IE8), you would u approach this problem?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How do you test cross-browser compatibility of your site?", content: "How do you test cross-browser compatibility of your site?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  ...
  {name: "Why reset css is useful? or how normalize.css works?", content: "Why reset css is useful? or how normalize.css works?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  ...
  {name: "Verify a prime number?", content: "Verify a prime number?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Find all prime factors of a number?", content: "Find all prime factors of a number?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Get nth Fibonacci number?", content: "Get nth Fibonacci number?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Find the greatest common divisor of two numbers?", content: "Find the greatest common divisor of two numbers?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Remove duplicate members from an array?", content: "Remove duplicate members from an array?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "merge two sorted array?", content: "merge two sorted array?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Swap two numbers without using a temp variable?", content: "Swap two numbers without using a temp variable?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Reverse a string in JavaScript?", content: "Reverse a string in JavaScript?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would you reverse words in a sentence?", content: "How would you reverse words in a sentence?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Reverse words in place?", content: "Reverse words in place?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Find the first non repeating char in a string?", content: "Find the first non repeating char in a string?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Remove duplicate characters from a sting?", content: "Remove duplicate characters from a sting?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How will you verify a word as palindrome?", content: "How will you verify a word as palindrome?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Generate random between 5 to 7 by using defined function.", content: "Generate random between 5 to 7 by using defined function.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Find missing number from unsorted array of integers.", content: "Find missing number from unsorted array of integers.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Get two numbers that equal to a given number?", content: "Get two numbers that equal to a given number?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Find the largest sum of any two elements?", content: "Find the largest sum of any two elements?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Total number of zeros from 1 upto n?", content: "Total number of zeros from 1 upto n?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Check whether a given string is a substring of bigger string", content: "Check whether a given string is a substring of bigger string", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Get permutaitons of a string", content: "Get permutaitons of a string", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Is there any difference between window and document?", content: "Is there any difference between window and document?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Does document.onload and window.onload fire at the same time?", content: "Does document.onload and window.onload fire at the same time?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Is attribute similar to property?", content: "Is attribute similar to property?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the different ways to get an element from DOM?", content: "What are the different ways to get an element from DOM?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is the fastest way to select elements by using css selectors?", content: "What is the fastest way to select elements by using css selectors?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How come, I can't use forEach or similar array methods on a NodeList?", content: "How come, I can't use forEach or similar array methods on a NodeList?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "If you need to implement getElementByAttribute, how would you implement it?", content: "If you need to implement getElementByAttribute, how would you implement it?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would you add a class to an element by query selector?", content: "How would you add a class to an element by query selector?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could I verify whether one element is child of another?", content: "How could I verify whether one element is child of another?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is the best way to create a DOM element? Set innherHTML or use createElement?", content: "What is the best way to create a DOM element? Set innherHTML or use createElement?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is createDocumentFragment and why you might use it?", content: "What is createDocumentFragment and why you might use it?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is reflow? What causes reflow? How could you reduce reflow?", content: "What is reflow? What causes reflow? How could you reduce reflow?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is repaint and when does this happen?", content: "What is repaint and when does this happen?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you make sure to run some JavaScript when DOM is ready like $(document).ready?", content: "How could you make sure to run some JavaScript when DOM is ready like $(document).ready?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is event bubble? How does event flows in DOM?", content: "What is event bubble? How does event flows in DOM?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would you destroy multiple list items with one click handler?", content: "How would you destroy multiple list items with one click handler?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Create a button that is destroyed by clicking in it but two new buttons are created in it's place.", content: "Create a button that is destroyed by clicking in it but two new buttons are created in it's place.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How could you capture all clicks in a page?", content: "How could you capture all clicks in a page?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How can you get all the texts in a web page?", content: "How can you get all the texts in a web page?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is defer and async keyword does in a script tag?", content: "What is defer and async keyword does in a script tag?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "10 rapid fire questions", content: "10 rapid fire questions", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Why do u need doctype?", content: "Why do u need doctype?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is the use of data-* attribute?", content: "What is the use of data-* attribute?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How can you generate public key in html?", content: "How can you generate public key in html?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How do you change direction of html text?", content: "How do you change direction of html text?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How can you highlight text in html?", content: "How can you highlight text in html?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Can you apply css to a part of html document only?", content: "Can you apply css to a part of html document only?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Will browser make http request for the following cases?", content: "Will browser make http request for the following cases?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Which resource would be downloaded first?", content: "Which resource would be downloaded first?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is optional tag?", content: "What is optional tag?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What are the differences between div and span?", content: "What are the differences between div and span?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How would you differentiate div, section and article?", content: "How would you differentiate div, section and article?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How to select svg or canvas for your site?", content: "How to select svg or canvas for your site?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "How to serve html in multiple languages?", content: "How to serve html in multiple languages?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "Explain standard and quirks mode.", content: "Explain standard and quirks mode.", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  {name: "What is semantic tag?", content: "What is semantic tag?", user_id: 1, difficulty: "", link: "https://github.com/khan4019/front-end-Interview-Questions", tag_id: nil},
  ...
  {name: "Two Sum III - Data structure design", content: "", user_id: 1, difficulty: "Easy", link: "https://leetcode.com/problems/two-sum-iii-data-structure-design/", tag_id: nil},
  ...
  {name: "Missing Ranges", content: "", user_id: 1, difficulty: "Medium", link: "https://leetcode.com/problems/missing-ranges/", tag_id: nil},
  ...
  {name: "One Edit Distance", content: "", user_id: 1, difficulty: "Medium", link: "https://leetcode.com/problems/one-edit-distance/", tag_id: nil},
  ...
  {name: "Longest Substring with At Most Two Distinct Characters", content: "", user_id: 1, difficulty: "Hard", link: "https://leetcode.com/problems/longest-substring-with-at-most-two-distinct-characters/", tag_id: nil},
  {name: "Read N Characters Given Read4 II - Call multiple times", content: "", user_id: 1, difficulty: "Hard", link: "https://leetcode.com/problems/read-n-characters-given-read4-ii-call-multiple-times/", tag_id: nil},
  {name: "Read N Characters Given Read4", content: "", user_id: 1, difficulty: "Easy", link: "https://leetcode.com/problems/read-n-characters-given-read4/", tag_id: nil},
  {name: "Binary Tree Upside Down", content: "", user_id: 1, difficulty: "Medium", link: "https://leetcode.com/problems/binary-tree-upside-down/", tag_id: nil},
  ...
  {name: "Flatten Binary Tree to Linked List", content: "<p></p>\n<p>\r\nGiven a binary tree, flatten it to a linked list in-place.\r\n</p><p>\r\nFor example,<br>\r\nGiven\r\n</p>\n", user_id: 1, difficulty: "Medium", link: "https://leetcode.com/problems/flatten-binary-tree-to-linked-list/", tag_id: nil},
  {name: "Path Sum II", content: "<p></p>\n<p>\r\nGiven a binary tree and a sum, find all root-to-leaf paths where each path's sum equals the given sum.\r\n</p><p>\r\nreturn<br>\r\n</p>\n", user_id: 1, difficulty: "Medium", link: "https://leetcode.com/problems/path-sum-ii/", tag_id: nil},
  {name: "Path Sum", content: "<p></p>\n<p>\r\nGiven a binary tree and a sum, determine if the tree has a root-to-leaf path such that adding up all the values along the path equals the given sum.\r\n</p><p>\r\nreturn true, as there exist a root-to-leaf path <code>5-&gt;4-&gt;11-&gt;2</code> which sum is 22.</p>", user_id: 1, difficulty: "Easy", link: "https://leetcode.com/problems/path-sum/", tag_id: nil},
  ...
  {name: "ZigZag Conversion", content: "<p></p>\n<p>\r\nThe string <code>\"PAYPALISHIRING\"</code> is written in a zigzag pattern on a given number of rows like this: (you may want to display this pattern in a fixed font for better legibility)\r\n</p>\n<p>\r\nWrite the code that will take a string and make this conversion given a number of rows:\r\n\r\n</p>\n", user_id: 1, difficulty: "Easy", link: "https://leetcode.com/problems/zigzag-conversion/", tag_id: nil},
  {name: "Longest Palindromic Substring", content: "<p></p>\n<p>Given a string <i>S</i>, find the longest palindromic substring in <i>S</i>. You may assume that the maximum length of <i>S</i> is 1000, and there exists one unique longest palindromic substring.</p>", user_id: 1, difficulty: "Medium", link: "https://leetcode.com/problems/longest-palindromic-substring/", tag_id: nil},
  {name: "Median of Two Sorted Arrays", content: "<p></p>\n<p>There are two sorted arrays <b>nums1</b> and <b>nums2</b> of size m and n respectively. Find the median of the two sorted arrays. The overall run time complexity should be O(log (m+n)).</p>", user_id: 1, difficulty: "Hard", link: "https://leetcode.com/problems/median-of-two-sorted-arrays/", tag_id: nil},
